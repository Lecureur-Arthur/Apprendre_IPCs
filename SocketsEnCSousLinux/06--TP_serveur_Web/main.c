 ...
 * Author: bguitton
 *
 * Created on 21 septembre 2020, 11:08
 */
...
int main(int argc, char *argv[]) {
    ...
    printf("serveur web TCP sur port 7777\n");
    ...
    adresseServeur.sin_addr.s_addr = htons(INADDR_ANY); // adresse IP du serveur dans l'ordre des octets du reseau
